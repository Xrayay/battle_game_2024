...
XrayayTank::XrayayTank(GameCore *game_core, uint32_t id, uint32_t player_id)
...
bool XrayayTank::IsHit(glm::vec2 position) const {
...
const char *XrayayTank::UnitName() const {
    return "XrayayTank";
}

const char *XrayayTank::Author() const {
    return "Xrayay";
}
